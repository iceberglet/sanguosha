...
export default function App() {
    ...
    let player = new PlayerInfo(p, Identity.ZHU_GONG, General.standard_diao_chan)
    ...
    let player2 = new PlayerInfo(new Player('欧阳挠挠'), Identity.ZHONG_CHEN, General.wind_zhang_jiao)
